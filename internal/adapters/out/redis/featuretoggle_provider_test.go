...
func seedToggle(t *testing.T, client *goredis.Client, name, value string) {
	t.Helper()
	require.NoError(t, client.HSet(context.Background(), "feature_toggles", name, value).Err())
}

func TestFeatureToggleProvider_IsEnabled_True(t *testing.T) {
	client := newTestClient(t)
	seedToggle(t, client, "dark-mode", `{"enabled":true,"description":"Dark mode"}`)

	p := redisAdapter.NewFeatureToggleProvider(client, zaptest.NewLogger(t))
	enabled, err := p.IsEnabled(context.Background(), "dark-mode")
	require.NoError(t, err)
	assert.True(t, enabled)
}

func TestFeatureToggleProvider_IsEnabled_False(t *testing.T) {
	client := newTestClient(t)
...
func TestFeatureToggleProvider_IsEnabled_Missing(t *testing.T) {
	client := newTestClient(t)
...
func TestFeatureToggleProvider_GetToggle(t *testing.T) {
	client := newTestClient(t)
...
func TestFeatureToggleProvider_GetToggle_NotFound(t *testing.T) {
	client := newTestClient(t)
...
func TestFeatureToggleProvider_ListToggles(t *testing.T) {
	client := newTestClient(t)
	seedToggle(t, client, "dark-mode", `{"enabled":true,"description":"Dark mode"}`)
...
func TestFeatureToggleProvider_ListToggles_Empty(t *testing.T) {
	client := newTestClient(t)
...
func TestFeatureToggleProvider_IsEnabled_CorruptData(t *testing.T) {
	client := newTestClient(t)
...
func TestFeatureToggleProvider_ListToggles_SkipsCorruptEntries(t *testing.T) {
	client := newTestClient(t)
